...
function savepage7(){
    ...
    sheet.pcdetail.age = document.status7.age.value;
    sheet.pcdetail.stature = document.status7.stature.value;
    sheet.pcdetail.weight = document.status7.weight.value;
    ...
    sheet.pcstatus.str[0] = document.status7.str0.value;
    sheet.pcstatus.str[1] = document.status7.str1.value;
    sheet.pcstatus.str[2] = document.status7.str2.value;
    sheet.pcstatus.str[3] = document.status7.str3.value;
    sheet.pcstatus.str[4] = document.status7.str4.value;
    sheet.pcstatus.con[0] = document.status7.con0.value;
    sheet.pcstatus.con[1] = document.status7.con1.value;
    sheet.pcstatus.con[2] = document.status7.con2.value;
    sheet.pcstatus.con[3] = document.status7.con3.value;
    sheet.pcstatus.con[4] = document.status7.con4.value;
    sheet.pcstatus.pow[0] = document.status7.pow0.value;
    sheet.pcstatus.pow[1] = document.status7.pow1.value;
    sheet.pcstatus.pow[2] = document.status7.pow2.value;
    sheet.pcstatus.pow[3] = document.status7.pow3.value;
    sheet.pcstatus.pow[4] = document.status7.pow4.value;
    sheet.pcstatus.dex[0] = document.status7.dex0.value;
    sheet.pcstatus.dex[1] = document.status7.dex1.value;
    sheet.pcstatus.dex[2] = document.status7.dex2.value;
    sheet.pcstatus.dex[3] = document.status7.dex3.value;
    sheet.pcstatus.dex[4] = document.status7.dex4.value;
    sheet.pcstatus.app[0] = document.status7.app0.value;
    sheet.pcstatus.app[1] = document.status7.app1.value;
    sheet.pcstatus.app[2] = document.status7.app2.value;
    sheet.pcstatus.app[3] = document.status7.app3.value;
    sheet.pcstatus.app[4] = document.status7.app4.value;
    sheet.pcstatus.siz[0] = document.status7.siz0.value;
    sheet.pcstatus.siz[1] = document.status7.siz1.value;
    sheet.pcstatus.siz[2] = document.status7.siz2.value;
    sheet.pcstatus.siz[3] = document.status7.siz3.value;
    sheet.pcstatus.siz[4] = document.status7.siz4.value;
    sheet.pcstatus.int[0] = document.status7.int0.value;
    sheet.pcstatus.int[1] = document.status7.int1.value;
    sheet.pcstatus.int[2] = document.status7.int2.value;
    sheet.pcstatus.int[3] = document.status7.int3.value;
    sheet.pcstatus.int[4] = document.status7.int4.value;
    sheet.pcstatus.edu[0] = document.status7.edu0.value;
    sheet.pcstatus.edu[1] = document.status7.edu1.value;
    sheet.pcstatus.edu[2] = document.status7.edu2.value;
    sheet.pcstatus.edu[3] = document.status7.edu3.value;
    sheet.pcstatus.edu[4] = document.status7.edu4.value;
    sheet.pcstatus.hp[0] = document.status7.hp0.value;
    sheet.pcstatus.hp[1] = document.status7.hp1.value;
    sheet.pcstatus.hp[2] = document.status7.hp2.value;
    sheet.pcstatus.mp[0] = document.status7.mp0.value;
    sheet.pcstatus.mp[1] = document.status7.mp1.value;
    sheet.pcstatus.mp[2] = document.status7.mp2.value;
    sheet.pcstatus.san[0] = document.status7.san0.value;
    sheet.pcstatus.san[1] = document.status7.san1.value;
    sheet.pcstatus.san[2] = document.status7.san2.value;
    sheet.pcstatus.idea[0] = document.status7.idea0.value;
    sheet.pcstatus.idea[1] = document.status7.idea1.value;
    sheet.pcstatus.idea[2] = document.status7.idea2.value;
    sheet.pcstatus.luck[0] = document.status7.luck0.value;
    sheet.pcstatus.luck[1] = document.status7.luck1.value;
    sheet.pcstatus.luck[2] = document.status7.luck2.value;
    sheet.pcstatus.know[0] = document.status7.know0.value;
    sheet.pcstatus.know[1] = document.status7.know1.value;
    sheet.pcstatus.know[2] = document.status7.know2.value;

    sheet.pcstatus.db = document.status7.db.value;
    sheet.pcstatus.mov = document.status7.mov.value;
    sheet.pcstatus.bld = document.status7.bld.value;
    sheet.pcstatus.bp[0] = document.status7.curBP.value;
    sheet.pcstatus.bp[1] = document.status7.maxBP.value;
    sheet.pcstatus.ip[0] = document.status7.curIP.value;
    sheet.pcstatus.ip[1] = document.status7.maxIP.value;
    sheet.pcstatus.sp[0] = document.status7.curSP.value;
    sheet.pcstatus.sp[1] = document.status7.maxSP.value;

    sheet.standstatus.parameter[0] = document.status7.power.value;
    sheet.standstatus.parameter[1] = document.status7.speed.value;
    sheet.standstatus.parameter[2] = document.status7.durability.value;
    sheet.standstatus.parameter[3] = document.status7.range.value;
    sheet.standstatus.parameter[4] = document.status7.accuracy.value;
    sheet.standstatus.parameter[5] = document.status7.growth.value;
    sheet.standstatus.parameter[6] = document.status7.dexS0.value;
    sheet.standstatus.parameter[7] = document.status7.dexS1.value;
    sheet.standstatus.parameter[8] = document.status7.dexS2.value;
    sheet.standstatus.db =           document.status7.dbS.value;
    sheet.standstatus.deffence =     document.status7.deffenceS.value;
    sheet.standstatus.mpcost =       document.status7.usempS.value;
    ...
    for(let table = 0; table < standabilitybattle.rows.length-1; table++){
        ...
        standstatus.num[0] = document.getElementsByName("defstandabilitybattle7"+table)[0].value;
        standstatus.num[1] = document.getElementsByName("corstandabilitybattle7"+table)[0].value;
        standstatus.num[2] = document.getElementsByName("plstandabilitybattle7"+table)[0].value;
        standstatus.num[3] = document.getElementsByName("addstandabilitybattle7"+table)[0].value;
        standstatus.num[4] = document.getElementsByName("tostandabilitybattle7"+table)[0].value;
    ...
    for(let table = 0; table < standabilityaction.rows.length-1; table++){
        ...
        standstatus.num[0] = document.getElementsByName("defstandabilityaction7"+table)[0].value;
        standstatus.num[1] = document.getElementsByName("corstandabilityaction7"+table)[0].value;
        standstatus.num[2] = document.getElementsByName("plstandabilityaction7"+table)[0].value;
        standstatus.num[3] = document.getElementsByName("addstandabilityaction7"+table)[0].value;
        standstatus.num[4] = document.getElementsByName("tostandabilityaction7"+table)[0].value;
    ...
    for(let table = 0; table < battle.rows.length-1; table++){
        ...
        pcstatus.num[0] = document.getElementsByName("defbattle7"+table)[0].value;
        pcstatus.num[1] = document.getElementsByName("bpbattle7"+table)[0].value;
        pcstatus.num[2] = document.getElementsByName("ipbattle7"+table)[0].value;
        pcstatus.num[3] = document.getElementsByName("plbattle7"+table)[0].value;
        pcstatus.num[4] = document.getElementsByName("addbattle7"+table)[0].value;
        pcstatus.num[5] = document.getElementsByName("tobattle7"+table)[0].value;
    ...
    for(let table = 0; table < search.rows.length-1; table++){
        ...
        pcstatus.num[0] = document.getElementsByName("defsearch7"+table)[0].value;
        pcstatus.num[1] = document.getElementsByName("bpsearch7"+table)[0].value;
        pcstatus.num[2] = document.getElementsByName("ipsearch7"+table)[0].value;
        pcstatus.num[3] = document.getElementsByName("plsearch7"+table)[0].value;
        pcstatus.num[4] = document.getElementsByName("addsearch7"+table)[0].value;
        pcstatus.num[5] = document.getElementsByName("tosearch7"+table)[0].value;
    ...
    for(let table = 0; table < action.rows.length-1; table++){
        ...
        pcstatus.num[0] = document.getElementsByName("defaction7"+table)[0].value;
        pcstatus.num[1] = document.getElementsByName("bpaction7"+table)[0].value;
        pcstatus.num[2] = document.getElementsByName("ipaction7"+table)[0].value;
        pcstatus.num[3] = document.getElementsByName("plaction7"+table)[0].value;
        pcstatus.num[4] = document.getElementsByName("addaction7"+table)[0].value;
        pcstatus.num[5] = document.getElementsByName("toaction7"+table)[0].value;
    ...
    for(let table = 0; table < negotiations.rows.length-1; table++){
        ...
        pcstatus.num[0] = document.getElementsByName("defnegotiations7"+table)[0].value;
        pcstatus.num[1] = document.getElementsByName("bpnegotiations7"+table)[0].value;
        pcstatus.num[2] = document.getElementsByName("ipnegotiations7"+table)[0].value;
        pcstatus.num[3] = document.getElementsByName("plnegotiations7"+table)[0].value;
        pcstatus.num[4] = document.getElementsByName("addnegotiations7"+table)[0].value;
        pcstatus.num[5] = document.getElementsByName("tonegotiations7"+table)[0].value;
    ...
    for(let table = 0; table < knowledge.rows.length-1; table++){
        ...
        pcstatus.num[0] = document.getElementsByName("defknowledge7"+table)[0].value;
        pcstatus.num[1] = document.getElementsByName("bpknowledge7"+table)[0].value;
        pcstatus.num[2] = document.getElementsByName("ipknowledge7"+table)[0].value;
        pcstatus.num[3] = document.getElementsByName("plknowledge7"+table)[0].value;
        pcstatus.num[4] = document.getElementsByName("addknowledge7"+table)[0].value;
        pcstatus.num[5] = document.getElementsByName("toknowledge7"+table)[0].value;
    ...
    for(let table = 0; table < etc.rows.length-1; table++){
        ...
        pcstatus.isinput = false;
        pcstatus.inputname = "";
        pcstatus.num[0] = document.getElementsByName("defetc7"+table)[0].value;
        pcstatus.num[1] = document.getElementsByName("bpetc7"+table)[0].value;
        pcstatus.num[2] = document.getElementsByName("ipetc7"+table)[0].value;
        pcstatus.num[3] = document.getElementsByName("pletc7"+table)[0].value;
        pcstatus.num[4] = document.getElementsByName("addetc7"+table)[0].value;
        pcstatus.num[5] = document.getElementsByName("toetc7"+table)[0].value;
